# OSAG English Defense Deck Audit (25-32 Minute Version)
...
- Latest thesis PDF detected (62 pages)
...
- Main-deck slide count: 21
- Backup slide count: 3
- Estimated main-deck speaking time: 27.40 minutes
- Main deck alone fits the 25-32 minute requirement: yes
- Live demo time is not counted in the estimate.

## Integrity Confirmation

- All key numbers were kept thesis-consistent.
...
- The title slide now includes an advisor signature area.
...
- PPT slide count check: 24
- PDF page count check: 24
